  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-white">
      <div className="w-full max-w-md p-8 bg-white rounded shadow-md">
        ...
        <p className="text-center text-gray-600 mb-6">Please enter your code that send to your phone</p>
        ...
        <p className="text-center text-gray-600 text-sm mt-2">
          Code not receive? <Link href="#" className="text-blue-600 hover:underline">Send again</Link>
        </p>
      </div>
    </div>
  );
